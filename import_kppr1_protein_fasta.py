...
INPUT_FILE = "KPPR1_PROTEIN_FASTA.csv"
DB_FILE = "pseudomonas_new.db"
TABLE_NAME = "kppr1_protein_fasta"
...
# Use the first column only; the other columns are empty
...
df.to_csv("KPPR1_Protein_FASTA_Clean.csv", index=False)
...
print()
print("Saved CSV: KPPR1_Protein_FASTA_Clean.csv")
print(f"Imported into SQLite table: {TABLE_NAME}")